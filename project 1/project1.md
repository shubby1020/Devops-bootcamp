...
![alt text](<img folder/Screen Shot 2024-08-19 at 21.32.12.png>)

# Go back to your EC2 dashboard and copy your Public IPv4 address.
![alt text](<img folder/Screen Shot 2024-08-19 at 21.33.59.png>)

Visit your instances Public IPv4 address in a web browser to view the default Nginx startup page.
![alt text](<img folder/Screen Shot 2024-08-19 at 21.34.11.png>)
...
![alt text](<img folder/Screen Shot 2024-08-28 at 17.47.59.png>)

# After clicking on it
Scroll down to the download section, right-click to open the menu, and select Inspect from the options.![alt text](<img folder/Screen Shot 2024-08-28 at 18.00.18.png>)

# Select the Network tab.
![alt text](<img folder/Screen Shot 2024-08-19 at 21.43.21.png>)

 # Click the Download button

 # After its done downloading
 in the network tab click on the zip file and choose copy and under copy choose copy url
 ![alt text](<img folder/Screen Shot 2024-08-19 at 21.50.34.png>)
...
![alt text](<img folder/Screen Shot 2024-08-19 at 21.51.47.png>)


# To install the unzip tool, run the following command: sudo apt install unzip.
![alt text](<img folder/Screen Shot 2024-08-19 at 21.56.09.png>)
...
![alt text](<img folder/Screen Shot 2024-08-19 at 22.33.36.png>)
 ...
 ![alt text](<img folder/Screen Shot 2024-08-19 at 22.34.52.png>)

# edit the root directory ro the new one
![alt text](<img folder/Screen Shot 2024-08-21 at 13.58.36.png>)
...
![alt text](<img folder/Screen Shot 2024-08-29 at 17.13.32.png>)

# Then you will see domain name
click on the one you want to manage
(![alt text](<img folder/Screen Shot 2024-08-29 at 17.13.55.png>)

 # Go back to your AWS console, search for Route 53①, and then choose Route 53② from the list of services shown.
![alt text](<img folder/Screen Shot 2024-08-29 at 17.15.28.png>)

# Click on Get started.
![alt text](<img folder/Screen Shot 2024-08-29 at 17.15.28.png>)

# Select Create hosted zones① and click on Get started②.
![alt text](<img folder/Screen Shot 2024-08-29 at 17.18.46.png>)

 # Enter your Domain name①, choose Public hosted zone② and then click on Create hosted zone③.
 ![alt text](<img folder/Screen Shot 2024-08-29 at 17.19.52.png>)

 # Select the created hosted zone① and copy the assigned Values②.
![alt text](<img folder/Screen Shot 2024-08-29 at 17.21.42.png>)

 #Paste the values you copied from Route 53 into the appropriate fields
![alt text](<img folder/Screen Shot 2024-08-30 at 07.59.05.png>)
